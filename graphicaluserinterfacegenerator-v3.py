...
# Display framework descriptions for all selected frameworks
if selected_frameworks:
    st.write("**Selected Frameworks Descriptions:**")
    for framework in selected_frameworks:
        framework_description = framework_descriptions.get(framework, "No description available.")
        st.write(f"- **{framework}:** {framework_description}")
else:
    st.write("**Selected Frameworks Descriptions:** No frameworks selected yet.")
...
if st.button("Generate"):
    if not api_key:
        ...
        # Construct the prompt for the API with multiple frameworks
        ...
        Include basic structure and comments for each section, integrating the selected frameworks appropriately."""
